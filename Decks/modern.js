...
module.exports = {
    last2Months, last2Weeks, lastMajorEvents, liveTournaments,
    all2023Decks, all2022Decks, all2021Decks, all2020Decks, all2019Decks,
    all2018Decks, all2017Decks, all2016Decks, all2015Decks, all2016Decks,
    all2015Decks, all2014Decks, all2013Decks, all2012Decks, all2011Decks,
    allModernDecks, allPt
};

async function allPt(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=92&a=");
...
async function allModernDecks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=44&a=");
...
async function all2011Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=78&a=");
...
async function all2012Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/archetype?f=MO&meta=76&a=189");
...
async function all2013Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/archetype?f=MO&meta=77&a=189");
...
async function all2014Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/archetype?f=MO&meta=79&a=189");
...
async function all2015Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=101&a=");
...
async function all2016Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=118&a=");
...
async function all2017Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=142&a=");
...
async function all2018Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=163&a=");
...
async function all2019Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=183&a=");
...
async function all2020Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=200&a=");
...
async function all2021Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=220&a=");
...
async function all2022Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=236&a=");
...
async function all2023Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=246&a=");
...
async function liveTournaments(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=57&a=");
...
async function lastMajorEvents(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=189&a=");
...
async function last2Weeks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=MO&meta=54&a=");
