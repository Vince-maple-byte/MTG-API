...
module.exports = {
    last4Months, last2Months, liveTournaments, all2023Decks,
    all2022Decks, all2021to2020Decks, all2019to2018Decks,
    all2017to2015Decks, all2014to2011Decks,
    allMajorEvents, allDecks
};

async function allDecks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=14&a=");
...
async function allMajorEvents(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=40&a=");
...
async function all2014to2011Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=15&a=");
...
async function all2017to2015Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=148&a=");
...
async function all2019to2018Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=167&a=");
...
async function all2021to2020Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=221&a=");
...
async function all2022Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=238&a=");
...
async function all2023Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=244&a=");
...
async function liveTournaments(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=83&a=");
...
async function last2Months(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI&meta=82&a=");
...
async function last4Months(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=VI");
