...
module.exports = {last2Months, last4Months, liveTournaments, 
    all2023Decks, all2022Decks, all2021Decks, all2020Decks,
...
async function last4Months(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=127&a=");
...
async function liveTournaments(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=185&a=");
...
async function all2023Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=251&a=");
...
async function all2022Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=239&a=");
...
async function all2021Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=224&a=");
...
async function all2020Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=223&a=");
...
async function all2019Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=186&a=");
...
async function all2018Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=170&a=");
...
async function all2017Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=169&a=");
...
async function all2016Decks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=168&a=");
...
async function allPauperDecks(){
    const browser = await puppeteer.launch();
    const page = await browser.newPage();
    await page.goto("https://www.mtgtop8.com/format?f=PAU&meta=110&a=");
